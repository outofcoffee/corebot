...
import com.gatehill.corebot.chat.model.template.SetRealNameTemplate
import com.gatehill.corebot.chat.model.template.SetUsernameTemplate
...
class Bootstrap @Inject constructor(actionDriverFactory: ActionDriverFactory,
    ...
    init {
        ...
        templateService.registerTemplate(SetUsernameTemplate::class.java)
        templateService.registerTemplate(SetRealNameTemplate::class.java)
    }
}
